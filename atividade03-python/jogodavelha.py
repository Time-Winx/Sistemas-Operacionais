...
def vencedor():
    if (table[0][0] == 'X' and table[0][1] == 'X' and table[0][2] == 'X' or 
        ...
        print('Máquina Dois (O) ganhou!')
    else:
        print('Empataram')


maquina_um = Thread(target=jogada_x, args= ('Máquina Um jogando!', 'X'))
maquina_dois = Thread(target=jogada_o, args= ('Máquina Dois jogando!', 'O'))
